...
import org.whale.system.addon.AddonRunUtil;
...
public abstract class BaseDao<T,PK> implements IBaseDao<T, PK>{
	...
	@Autowired
	private AddonRunUtil addonRunUtil;
	//该类Dao 插件上下文
	@Autowired
	...
	public void save(T t){
		...
		addonRunUtil.runBeforeSave(t, this);
		...
		addonRunUtil.runAfterSave(t, this);
	}
	...
	public void saveBatch(List<T> list){
		...
		addonRunUtil.runBeforeSaveBatch(list, this);
		this.batch(ormValues);
		addonRunUtil.runAfterSaveBatch(list, this);
    }
	...
	public void update(T t){
		...
		addonRunUtil.runBeforeUpdate(t, this);
		this.jdbcTemplate.update(ormValues.getSql(), ormValues.getArgs());
		addonRunUtil.runAfterUpdate(t, this);
	}
	...
	public void updateBatch(List<T> list){
		...
		addonRunUtil.runBeforeUpdateBatch(list, this);
		this.batch(ormValues);
		addonRunUtil.runAfterUpdateBatch(list, this);
	}
	...
	public void delete(PK id){
		...
		addonRunUtil.runBeforeDelete(id, this);
		this.jdbcTemplate.update(ormValues.getSql(), ormValues.getArgs());
		addonRunUtil.runAfterDelete(id, this);
	}
	...
	public void delete(List<PK> ids) {
		...
		addonRunUtil.runBeforeDeleteBatch(ids, this);
		this.batch(ormValues);
		addonRunUtil.runAfterDeleteBatch(ids, this);
	}
	...
	public void deleteBy(T t) {
		...
		addonRunUtil.runBeforeDelete(t, this);
		this.jdbcTemplate.update(ormValues.getSql(), ormValues.getArgs());
		addonRunUtil.runAfterDelete(t, this);
	}
	...
	public T getObject(String sql, Object...args){
		List<T> list = this.query(sql, args);
