        ...
        <form class="form-horizontal m-t" id="dataForm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-11 form-inline input-group" style="padding-left:0px;">
                    <input id="dictName" name="dictName" value="${item.dictName }" class="form-control" style="width:250px"  >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-md-2 col-lg-1 control-label"><i>*</i>字典编码：</label>
                <div class="col-sm-9 col-md-10 col-lg-11 form-inline input-group" style="padding-left:0px;">
                    <input id="dictCode" name="dictCode" value="${item.dictCode }" class="form-control" style="width:250px" readonly="readonly" >
                </div>
            </div>
            <div class="form-group">
