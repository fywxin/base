...
<body style="overflow-x: hidden;"> 
	<ul class="nav nav-tabs" id="topTab">
    	<li><a href="#" onclick="go('${ctx}/dictItem/goList?dictId=${dictId}')">查询字典元素</a></li>
    	<li class="active"><a href="#"><i class="fa fa-plus"></i> 新增字典元素</a></li>
	</ul>
        ...
        <form class="form-horizontal m-t" id="dataForm">
            ...
            <div class="form-group">
                <div class="col-sm-12 col-sm-offset-2">
                    ...
                    <button class="btn btn-success" type="button" id="continueBut" onclick="go('${ctx}/deptItem/goSave?dictId=${dictId}');" style="display: none;"><i class='fa fa-thumbs-up'></i> 继续添加</button>
                </div>
            </div>
		</form>
	</div>
