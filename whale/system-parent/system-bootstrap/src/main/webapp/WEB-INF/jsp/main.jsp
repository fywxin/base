...
<head>
    ...
    <link href="${html }/frame/css/font-awesome.min.css" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="${html }/frame/img/profile_small.jpg" /></span>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${html }/frame/index_v1.html" data-index="0">主页示例一</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="social_feed.html">社交</a>
                            </li>
                            ...
                            <li><a class="J_menuItem" href="faq.html">帮助中心</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${html }/frame/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${html }/frame/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${html }/frame/index_v1.html?v=3.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${html }/frame/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${html }/frame/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${html }/frame/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${html }/frame/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${html }/frame/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${html }/frame/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <script src="${html }/frame/js/bootstrap.min.js"></script>
    <script src="${html }/frame/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="${html }/frame/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="${html }/frame/js/plugins/layer/layer.min.js"></script>
    <script src="${html }/frame/js/hplus.js"></script>
    <script src="${html }/frame/js/contabs.js"></script>
    <script src="${html }/frame/js/plugins/pace/pace.min.js"></script>
</body>
