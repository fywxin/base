...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
    	formId: 'queryForm', //wjs
    	uid: "id", //wjs 树id 用于树列表，将行转化为列
    	pid: "pid", //wjs 树pid
    	orderCol: "orderNo", //wjs 树排序列
    	orderAsc: true,  //wjs 树递增排序
        title: null,
        width: 'auto',                          //宽度值
        height: 'auto',                          //宽度值
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        loadData: function (loadDataParm)
        {
            ...
            if (p.dataAction == "server")
            {
            	...
            	if(p.formId){ //wjs
            		var fData = $("#"+p.formId).serializeArray();
        ...
        */
        ...
        getSelIds: function ()  //wjs 增加  getSelIds 方法 对应 uid参数
        {
            var arr = [];
            for (var i in this.selected)
            {
        ...
        _initColumns: function ()
        {
            ...
            $(g.columns).each(function (i, column)
            {
                ...
                column.isSort = column.isSort == true ? true : false; //wjs
        ...
        _onClick: function (e)
        {
            ...
            else if (src.row && g.enabledCheckbox()) //复选框选择行  wjs-复选框事件行
            {
                //复选框
