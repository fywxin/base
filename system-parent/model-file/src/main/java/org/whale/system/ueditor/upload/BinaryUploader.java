package org.whale.system.ueditor.upload;


import org.springframework.web.multipart.MultipartFile;
import org.springframework.web.multipart.MultipartHttpServletRequest;
import org.whale.system.domain.FileInfo;
import org.whale.system.router.FileInfoRouter;
import org.whale.system.service.FileInfoService;
import org.whale.system.ueditor.define.AppInfo;
import org.whale.system.ueditor.define.BaseState;
import org.whale.system.ueditor.define.FileType;
import org.whale.system.ueditor.define.State;
	...
	public static final State save(HttpServletRequest request, Map<String, Object> conf) {
		...
		for (Map.Entry<String, MultipartFile> entry : fileMap.entrySet()) {
			try {
				...
				FileInfoRouter.decorateFileInfo(multipartFile, fileInfo);
				...
				String info = FileInfoRouter.doSaveStream(fileInfo, multipartFile);
