...
public class HttpDownloadUtil {
    ...
    public boolean download(URL source, File dest,  DownloadProgress progress, long timeout) throws Exception {
        ...
        try {
            ...
            if (getThread.isAlive()) {
                throw new HttpClientException("The GET operation took longer than " + timeout + ", stopping it.");
            }
        }
